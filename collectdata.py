...
while True:
    _,frame=cap.read()
    count = {
             'A':len(os.listdir(directory+"/i_love_u")),
             'B':len(os.listdir(directory+"/thank_u")),
             'C':len(os.listdir(directory+"/bye")),
             'D':len(os.listdir(directory+"/welcome")),
             'E':len(os.listdir(directory+"/namaste")),
             'F':len(os.listdir(directory+"/home")),
    ...
    if interrupt & 0xFF == ord('A'):
        cv2.imwrite(directory+'i_love_u/'+str(count['A'])+'.png',frame)
    if interrupt & 0xFF == ord('B'):
        cv2.imwrite(directory+'thank_u/'+str(count['B'])+'.png',frame)
    if interrupt & 0xFF == ord('C'):
        cv2.imwrite(directory+'bye/'+str(count['C'])+'.png',frame)
    if interrupt & 0xFF == ord('D'):
        cv2.imwrite(directory+'welcome/'+str(count['D'])+'.png',frame)
    if interrupt & 0xFF == ord('E'):
        cv2.imwrite(directory+'namaste/'+str(count['E'])+'.png',frame)
    if interrupt & 0xFF == ord('F'):
        cv2.imwrite(directory+'home/'+str(count['F'])+'.png',frame)
    if interrupt & 0xFF == ord('a'):
